...
let getShows = function() {
    return [
        {   movie_id : 'swordofdestiny',
            ...
            movie_details : 'handsome ! handsome !! handsome !!!(fantastic fantastic fantastic: Miecz przeznaczenia), is the second (in its fictional chronology; first in Polish print) of the two collections of short stories (the other being The Last Wish), both preceding the main Witcher Saga. The stories were written by Polish fantasy writer Andrzej Sapkowski. The first Polish edition was published in 1992;[1] the English edition was published in the UK by Gollancz in 2015'},
           {movie_id: 'johnwane', 
           movie_Name: 'johnwane',
